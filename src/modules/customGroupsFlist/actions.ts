...
export const actionTypes = {
  ...
  SET_LINK_NAME: `${appName}/${moduleName}/SET_LINK_NAME`,
  ADD_DEFAULT_FOLDERS: `${appName}/${moduleName}/ADD_DEFAULT_FOLDERS`,
 ...
 */
export const getGroupCompleteAction = (Args: getGroupCompleteActionType) => {
...
/**
 * Установить новое имя для ссылки linkName
 * @param {Array} list - Массив объектов камер либо папок
 */

export const setLinkNameAction = (linkName: string) => ({
