...
import { CursorOptions } from "./types/CursorTypes";
import RoundedRect from "../shapes/roundedRect/RoundedRect";

import { CURSOR_COLOR, CURSOR_TEXT_COLOR, FONT_SIZE } from "../../config";
...
export default class Cursor {
  ...
  private readonly _color: string = CURSOR_COLOR;
  ...
  private renderTime(context: CanvasRenderingContext2D): void {
    ...
    const renderTimeString = () => {
      ...
      context.beginPath();
      context.fillStyle = CURSOR_TEXT_COLOR;
